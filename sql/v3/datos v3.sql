...
INSERT INTO `plumasdocentes`.`programasinvestigacion` (`id`, `Nombre`, `Director`, `Codirector`, `Estado`) VALUES ('6', 'PROGRAMA DE INVESTIGACIÓN EN ECOTOXICOLOGÍA', '2786', '1358', '0');
INSERT INTO `plumasdocentes`.`programasinvestigacion` (`id`, `Nombre`, `Director`, `Codirector`, `Estado`) VALUES ('7', 'PROGRAMA DE ESTUDIOS DE POLITICA, HISTORIA Y DERECHO (EPHyD)', '268', '257', '0');
INSERT INTO `plumasdocentes`.`programasinvestigacion` (`id`, `Nombre`, `Director`, `Codirector`, `Estado`) VALUES ('8', 'PROGRAMA DE INVESTIGACIONES EN ECOLOGÍA TERRESTRE', '2194', '2176', '0');
INSERT INTO `plumasdocentes`.`programasinvestigacion` (`id`, `Nombre`, `Director`, `Codirector`, `Estado`) VALUES ('9', 'Programa de Estudios sobre Fundamentos Teórico-Metodológicos del Trabajo Social', '1193', '2609', '0');
INSERT INTO `plumasdocentes`.`programasinvestigacion` (`id`, `Nombre`, `Director`, `Codirector`, `Estado`) VALUES ('10', 'Programa De Ecofisiología Aplicada', '521', '480', '0');
INSERT INTO `plumasdocentes`.`programasinvestigacion` (`id`, `Nombre`, `Director`, `Estado`) VALUES ('11', 'DIAGNÓSTICO INTEGRAL DEL ÁREA DE INFLUENCIA DE LA UNIVERSIDAD NACIONAL DE LUJÁN', '2459', '0');

INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('16', ' Genotoxic Evidences of Glyphosate and Chlorpyriphos on Eisenia fetida Coelomocytes', '2011-08-30', '427', '6', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('17', ' The ecotoxicity of binary mixtures of Imazamox and ionized ammonia on freshwater copepods: Implications for environmental risk assessment in groundwater bodies', '2014-07-11', '1193', '6', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('18', 'Evidences of oxidative stress during hydrogen photoproduction by means of sulfur-deprived Chlamydomonas reinhardtii cultures.', '2008-11-18', '2609', '6', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('19', 'Toxicity assessment of Cyfluthrin commercial formulation on growth, photosynthesis and catalase activity of green algae. Pesticide Biochemistry and Physiology.', '2012-01-28', '1640', '6', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('20', 'Effects of a commercial formulation of Cypermethrin used in biotech soybean crops on growth and antioxidant enzymes of freshwater algae. International Journal of Environmental Protection', '2011-11-18', '1640', '6', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('21', 'Sociedad civil y Salud: de reclamos y memorias.', '2016-06-22', '427', '7', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('22', 'Los Modelos en Trabajo Social y implicancia en el ejercicio profesional', '2016-06-22', '107', '7', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('23', 'Del Estado Benefactor al Estado Punitivo. El poder de policía: conceptos, normas y prácticas políticas aplicadas en el aglomerado Gran Buenos Aires entre 1946 y1968.', '2007-04-06', '3049', '7', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('24', 'Necesidades e infancias', '2008-07-14', '143191', '7', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('25', 'Análisis de un gradiente de disturbio: cambios en la velocidad de descomposición e incorporación de la materia orgánica y se relación con la meso y la macro fauna.', '2013-08-05', '1640', '8', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('26', 'Indicadores de sustentabilidad del suelo basados en la estructura y funcionamiento de la fauna edáfica. ', '2017-04-29', '143191', '8', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('27', 'Relaciones interespecíficas entre los parasitoides larvales Dineulophus phtherimaeae De Santis y Pseudiapanteles dignus. Implicancias para el control biológico de Tuta absoluta. CDD-CB 006-16', '2010-05-19', '3049', '8', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('28', 'Degradación de suelos agrícolas medida a través de sus efectos sobre la estructura y el funcionamiento del ecosistema edáfico', '2010-09-26', '1193', '8', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('29', 'Las intervenciones sociales impulsadas por las iglesias protestantes entre 1870-1930 en Argentina y sus vinculaciones con el proceso de institucionalización del Trabajo Social', '2013-03-21', '2194', '8', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('30', 'El debate actual en Ciencias Sociales. Análisis de las influencias de las categorías de realidad, sujeto y contemporaneidad en la obra de Pierre Bourdieu y Michel Foucault sobre el trabajo social argentino en el período 1994-2004', '2011-08-13', '3049', '9', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('31', 'Fundamentos y estrategias de intervención de los actores institucionales en el abordaje de la niñez: Estudio de caso en los municipios de Luján y Gral. Rodríguez', '2011-08-13', '3049', '9', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('32', 'El ejercicio profesional del Trabajo Social en las actuales relaciones Estado-Sociedad', '2007-05-30', '1640', '9', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('33', 'Implicancias de los cambios teóricos y legislativos en el abordaje a la niñez', '2015-06-01', '3049', '9', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('34', 'Effect of ibuprofeno thes swimming pattern of Cyprinus carpio', '2015-06-01', '3049', '9', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('35', 'Respuesta de biomarcadores bioquímicos, morfológicos y comportamentales de la carpa común, Cyprinus carpio, por exposición a muestras ambientales.', '2015-08-27', '2675', '10', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('36', 'Cadmium Toxicity assessment in juveniles of he Austral South America amphipod Hyalella curvispina.', '2014-02-10', '2675', '10', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('37', ' Energy balance of juvenile Cyprinus carpio after a short-term exposure to sublethal water-borne cadmium.', '2009-06-12', '143191', '10', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('38', ' Cadmium toxicity in tadpoles of Rhinella arenarum in relation to calcium and humic acids.', '2010-06-23', '2653', '10', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('39', 'Investigación y desarrollo territorial (3ra etapa) - Agendas ambientales y gestión participada de riesgos: componentes de relevancia para una ordenación ambiental desde multicriterios', '2014-07-14', '1108', '10', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('40', 'Observatorio de los graduados del Centro Regional Campana. Dinámica profesional y vinculación con el medio. (Continua)', '2010-08-03', '268', '11', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('41', 'Evolución, alcance e impacto de los servicios de vinculación tecnológica de la UNLu en su zona de influencia.', '2013-01-05', '427', '11', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('42', 'Taller de muestreo y diseño de encuestas', '2013-03-08', '318', '11', '0');
INSERT INTO `plumasdocentes`.`proyectos` (`id`, `Nombre`, `FechaPresentacion`, `Director`, `Programa`, `Estado`) VALUES ('43', 'Los Graduados de la Universidad Nacional de Luján (UNLu) y su Inserción en el Contexto del Área de Influencia:', '2012-07-28', '107', '11', '0');
