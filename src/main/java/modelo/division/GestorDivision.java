...
public class GestorDivision {
	...
	public EstadoOperacion nuevaDivision(IDivision division) {
		try {
			...
			return e.isEstado()?new EstadoOperacion(CodigoEstado.INSERT_OK, "La division se creó correctamente"):new EstadoOperacion(CodigoEstado.INSERT_ERROR, "No se pudo crear el Proyecto");
	...
	public EstadoOperacion modificarDivision(IDivision division) {
		try {
			...
			return e.isEstado()?new EstadoOperacion(CodigoEstado.UPDATE_OK, "La division se modificó correctamente"):
	...
	public List<IDivision> listarDivision(IDivision division) {
		...
		try {
			...
			for (Hashtable<String, String> reg : res) {
				...
				d.setCodigo(Integer.parseInt(reg.get("Codigo")));
