 ...
 */
public class UsuariosAnterior extends ControladorVista implements Initializable {
...
// -------------------------------- General --------------------------------- //
	...
	@FXML public void seleccionarPersona(ActionEvent event) {
        ...
        args.put(GestorPantalla.KEY_PADRE, UsuariosAnterior.TITULO);
	...
	@FXML public void buscarUsuario(ActionEvent event) {
        ...
        args.put(Busqueda.KEY_TIPO, UsuariosAnterior.TITULO);
        args.put(Busqueda.KEY_CONTROLADOR, this);
        args.put(Busqueda.KEY_TIPO_RESPUESTA, TIPO_USUARIO);
        args.put(GestorPantalla.KEY_PADRE, UsuariosAnterior.TITULO);
        this.gestorPantalla.lanzarPantalla(Busqueda.TITULO + " " + UsuariosAnterior.TITULO, args);
	}
