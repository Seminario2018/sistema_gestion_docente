 ...
 */
public class DocentesAnterior extends ControladorVista implements Initializable {
...
// -------------------------------- General --------------------------------- //
	...
	@FXML private void buscarDocente() {
		...
		args.put(Busqueda.KEY_TIPO, DocentesAnterior.TITULO);
		args.put(Busqueda.KEY_CONTROLADOR, this);
		args.put(Busqueda.KEY_TIPO_RESPUESTA, TIPO_DOCENTE);
		args.put(GestorPantalla.KEY_PADRE, DocentesAnterior.TITULO);
		this.gestorPantalla.lanzarPantalla(Busqueda.TITULO + " " + DocentesAnterior.TITULO, args);
	}
