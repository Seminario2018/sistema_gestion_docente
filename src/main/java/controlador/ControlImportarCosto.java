...
public class ControlImportarCosto {
	...
	public void guardar() {
		...
		switch (eo.getEstado()) {
		case UPDATE_OK:
			this.vista.dialogoConfirmacion(tituloDialogo, "Éxito al actualizar los datos", eo.getMensaje());
			break;
		default:
			this.vista.alertaError(tituloDialogo, "No se pudieron actualizar los datos", eo.getMensaje());
		}
	}
